...
struct DataTypesListView: View {
    ...
    @State var descriptions = ["Detects abnormally high heart rate while asleep.", "Used to omit data taken at night while your still active."]//, "Monitors for high breathing rates while asleep (only WatchOS 8).", "Detects low oxygen in your blood (only Apple Watch 6)."]
    var body: some View {
        VStack {
